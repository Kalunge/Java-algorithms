...
class SumUpExample {
    ...
    static public void twoThreads() throws InterruptedException {
        ...
        System.out.println("Two threads final count = " + finalCount + " took  " + (end - startTime) + " milliseconds");
    ...
    static public void oneThread() throws InterruptedException {
        ...
        long end = System.currentTimeMillis();
        System.out.println("Single thread finale count = " + s.counter + " took " + (end - start) + " Milliseconds");
    }
